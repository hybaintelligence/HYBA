...
class TestExecutionPipelineIntegration:
    ...
    def test_successful_execution_full_pipeline(self, tmp_path):
        ...
        autonomous = AutonomousQaaSController(
            service_id="test_service", service_kind="qaas", persistence_dir=tmp_path
        )
        autonomous.start()
    ...
    def test_failed_execution_triggers_rollback(self, tmp_path):
        ...
        autonomous = AutonomousQaaSController(
            service_id="fail_service", service_kind="qaas", persistence_dir=tmp_path
        )
        autonomous.start()
        ...
        result = coordinator.execute_with_protection(
            customer_id="fail_customer", work_units=150, execution_fn=failing_workload
        )
    ...
    def test_insufficient_quota_blocks_execution(self):
        ...
        coordinator = ExecutionCoordinator(
            quota_manager=quota_mgr, billing_manager=billing_mgr
        )
        ...
        result = coordinator.execute_with_protection(
            customer_id="poor_customer", work_units=100, execution_fn=expensive_workload
        )
    ...
    def test_multiple_executions_track_correctly(self, tmp_path):
        ...
        autonomous = AutonomousQaaSController(
            service_id="multi_service", service_kind="qaas", persistence_dir=tmp_path
        )
        autonomous.start()
        ...
        for exec_fn, units, should_succeed in executions:
            result = coordinator.execute_with_protection(
                customer_id="multi_customer", work_units=units, execution_fn=exec_fn
            )
...
class TestAutonomousControllerIntegration:
    ...
    def test_autonomous_records_successful_executions(self, tmp_path):
        ...
        autonomous = AutonomousQaaSController(
            service_id="auto_service", service_kind="qaas", persistence_dir=tmp_path
        )
        autonomous.start()
    ...
    def test_autonomous_triggers_healing_on_failures(self, tmp_path):
        ...
        autonomous = AutonomousQaaSController(
            service_id="heal_service", service_kind="qaas", persistence_dir=tmp_path
        )
        autonomous.start()
...
class TestDailyReconciliationIntegration:
    ...
    def test_daily_reconciliation_aggregates_all_refunds(self, tmp_path):
        ...
        autonomous = AutonomousQaaSController(
            service_id="recon_service", service_kind="qaas", persistence_dir=tmp_path
        )
        autonomous.start()
