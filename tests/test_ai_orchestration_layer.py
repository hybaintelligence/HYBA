...
class TestAIAdvisorySystem:
    ...
    def test_generate_advisory_low_hashrate(self):
        ...
        assert (
            "performance" in recommendation.recommendation_type.lower()
            or "optimization" in recommendation.recommendation_type.lower()
        )
    ...
    def test_detect_anomalies_normal(self):
        ...
        metrics = {"hashrate": 100.0, "temperature": 50.0, "efficiency": 0.8}
...
class TestUnifiedAIOrchestrationLayer:
    ...
    def test_enable_disable_ai_stage(self):
        ...
        assert not orchestration.ai_stage_status[AIStage.INITIALIZATION]

        orchestration.enable_ai_stage(AIStage.INITIALIZATION)
        assert orchestration.ai_stage_status[AIStage.INITIALIZATION]
