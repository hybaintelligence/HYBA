...
class TestQuantumMathematicsIsSubstrateAgnostic:
    ...
    def test_coxeter_group_structure_is_exact_mathematical_object(self):
        ...
        assert cert.coxeter_matrix == [[1, 5, 3], [5, 1, 3], [3, 3, 1]], "Matrix is exact mathematical object"
    ...
    def test_quantum_state_evolution_is_deterministic_mathematical_transform(self, dim):
        ...
        psi_evolved_2 = U @ psi
        assert np.allclose(psi_evolved, psi_evolved_2, atol=1e-14), "Evolution is deterministic (mathematical property)"
