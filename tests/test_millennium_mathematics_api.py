...
class TestHodgeConjecture:
    ...
    def test_memory_geometry_analysis(self):
        ...
        from hyba_genesis_api.api.millennium_mathematics import HodgeConjectureOperations
...
class TestPoincareConjecture:
    ...
    def test_topological_identity_preservation(self):
        ...
        from hyba_genesis_api.api.millennium_mathematics import PoincareConjectureOperations
...
class TestClaimBoundaries:
    ...
    def test_all_operations_have_claim_boundaries(self):
        ...
        for problem in service.OPERATIONS:
            ...
            assert "not a proof" in service.CLAIM_BOUNDARIES[problem].lower() or \
                   "proven by" in service.CLAIM_BOUNDARIES[problem].lower()
