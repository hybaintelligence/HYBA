...
def validate_latency_profiler():
    ...
    try:
        ...
        speedup = profiler.compute_amdahl_speedup(bottleneck_fraction=0.5, speedup_factor=10)
...
def validate_supporting_modules():
    ...
    try:
        ...
        assert canonical_map.shape == (32, 3), f"Expected shape (32, 3), got {canonical_map.shape}"
