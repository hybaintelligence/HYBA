...
def claim_checks() -> list[dict[str, object]]:
    ...
    resonance = find_number(payload, {"resonance", "resonance_rate", "phi15_resonance", "phi_15_resonance", "resonance_percent"})
    ...
    z_score = find_number(payload, {"z", "z_score", "zscore"})
...
def main() -> int:
    ...
    result = {
        ...
        "doctrine": {
            ...
            "accepted_share_claim_requires_pool_ack": True,
        },
    }
