...
def validate_backend_components():
    ...
    try:
        from hyba_genesis_api.api.auth import _verify_operator
    ...
    try:
        from hyba_genesis_api.database import SessionLocal, init_db
...
def validate_deployment_files():
    ...
    # Check seed script
    seed_script_path = Path(__file__).parent.parent / "python_backend" / "scripts" / "seed_admin_user.py"
