...
BANNED_PATTERNS = [
    ...
    (
        re.compile(
            r"(?<!no\s)(?<!no\sfabricated,\s)(?<!no\sfabricated,\s)fixture\s+(?:telemetry|state|audit)",
            re.IGNORECASE,
        ),
        "fixture semantic audit label",
    ),
    (
        re.compile(
            r"(?<!no\s)(?<!no\sfabricated,\s)(?<!no\sfabricated,\s)placeholder\s+(?:telemetry|state|audit)",
            re.IGNORECASE,
        ),
        "placeholder semantic audit label",
    ),
