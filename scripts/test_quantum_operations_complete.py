...
print(
    f'  ✓ Scaling dimensions: {len(summary["scaling_dimensions"]["scaling_dimensions"])}'
)
print(
    f'  ✓ Central charge: {summary["entanglement_entropy_scaling"]["estimated_central_charge"]:.4f}'
)
print()
...
print(
    f'  ✓ Spectral gap: {ym_summary["spectral_gap"]["gap_estimate_lattice_units"]:.6f}'
)
print()
