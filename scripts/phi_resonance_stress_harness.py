...
def run_harness(exponents: list[int], *, inject_every: int = 3) -> dict[str, Any]:
    ...
    for index, exponent in enumerate(exponents):
        ...
        entry = ledger.append(certificate_type, {"tier": tier, "stability": report.to_dict()}, timestamp_ns=exponent)
        passport = QuantumRuntimePassport(
            ...
            phi_scale_factor_fixed=int(min(1_000_000_000, round(tier["phi_exponent"] / 120 * 1_000_000_000))),
        )
