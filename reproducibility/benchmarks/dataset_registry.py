...
class RealWorldDatasetRegistry:
    ...
    def _load_or_generate_dataset(
        ...
        if dataset_id == "portfolio_optimization":
            ...
            self._log(
                "Generated portfolio optimization dataset: shape={}", returns.shape
            )
            return returns
            ...
            self._log(
                "Generated synthetic quantum chemistry dataset: shape={}", data.shape
            )
            return data
            ...
            self._log(
                "Generated synthetic materials science dataset: shape={}", data.shape
            )
            return data
