      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-lg border border-slate-100 bg-slate-50 p-4">
            ...
            <div className="text-2xl font-bold text-slate-950">
              {usage.currency}{usage.current_period_cost.toFixed(2)}
            </div>
            <div className="mt-1 text-xs text-slate-500">
        ...
        <div className="mt-6 rounded-lg border border-blue-100 bg-blue-50 p-4">
          <p className="text-sm text-blue-950">
            <strong>Transparent metering:</strong> Every compute unit is tracked, auditable, and tied to evidence-sealed execution.
            No surprise charges. No hidden fees. Mathematics you can verify.
          </p>
        </div>
      </div>
    </div>
