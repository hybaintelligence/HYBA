        ...
        <div className="flex-1 space-y-4 font-mono">
            <div className="grid grid-cols-2 gap-4">
               ...
               <div className="bg-[#001c3d] p-3 rounded border border-[#0A5C91]">
                  ...
                  <div className="text-sm font-bold text-white">10^{Math.log10(powerScale * 1e18).toFixed(0)}</div>
               </div>
            </div>
            ...
            <div className="bg-[#001c3d] p-4 rounded border border-[#0A5C91] relative overflow-hidden">
               ...
               <div className="text-[9px] text-[#94A3B8] uppercase mb-1">Time to Next Share (Resonance Estimate)</div>
            ...
            <div className="text-[10px] text-gray-400 italic">
               *Hilbert space projection stabilized at Φ-resonance {phiResonance.toFixed(4)}. 
               Quantum tunneling detected in subspace vertices.
            </div>
        </div>
      </div>
    </div>
