            ...
            <form onSubmit={handleProvision} className="space-y-4">
              <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-4">
                ...
                <p className="mt-2 text-xs text-emerald-800">
                  {isExpertMode
                    ? "Technical fields are visible for this lens."
                    : "Technical fields are hidden by default; presets map to safe defaults."}
                </p>
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="operations-ci-rail"
                />
              </div>
              ...
              {isExpertMode && (
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-xs font-semibold text-slate-900">Technical Configuration</p>
                  <div className="mt-2 grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs text-slate-700">Code Distance</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-xs text-slate-700">Logical Compute Units</label>
                      <input
                        type="number"
