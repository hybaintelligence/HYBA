...
class TestHybaClient:
    ...
    def test_client_custom_base_url(self):
        ...
        client = HybaClient(
            api_key="hyba_live_test", base_url="https://sandbox.api.hyba.ai"
        )
    ...
    def test_client_custom_timeout(self):
        ...
        client = HybaClient(api_key="hyba_live_test", timeout=60)
...
class TestHybaClientServiceManagement:
    ...
    def test_provision_service_with_connector(self, mock_request, client):
        ...
        service = client.provision_service(name="test-service", connector=connector)
...
class TestConnectorConfig:
    ...
    def test_connector_to_dict_optional_fields(self):
        ...
        connector = ConnectorConfig(
            type=ConnectorType.HTTP, endpoint="https://api.example.com"
        )
    ...
    def test_connector_repr(self):
        ...
        connector = ConnectorConfig(type=ConnectorType.SQL_POSTGRESQL, host="localhost")
