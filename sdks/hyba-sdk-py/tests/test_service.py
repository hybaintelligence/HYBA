...
class TestServiceLifecycle:
    ...
    def test_start_service_from_provisioned(self, service, mock_client):
        ...
        assert call_args[0] == (
            "POST",
            "/api/v1/computational-intelligence-services/svc-001/start",
        )
    ...
    def test_stop_service_from_running(self, service, mock_client):
        ...
        assert call_args[0] == (
            "POST",
            "/api/v1/computational-intelligence-services/svc-001/stop",
        )
...
class TestServiceExecution:
    ...
    def test_execute_workload(self, service, mock_client):
        ...
        result = service.execute(workload="explain", context="test context")
        ...
        assert call_args[0] == (
            "POST",
            "/api/v1/computational-intelligence-services/svc-001/execute",
        )
...
class TestServiceRefreshAndDelete:
    ...
    def test_delete_service(self, service, mock_client):
        ...
        assert call_args[0] == (
            "DELETE",
            "/api/v1/computational-intelligence-services/svc-001",
        )
