...
echo "║  Default Pool:     Braiins (auto-connected)                    ║"
echo "║  Mode:             Development (dev fixtures)                  ║"
echo "║  Status:           Mining auto-started                         ║"
echo "║  Duration:         20 minutes (or until Ctrl+C)                ║"
echo "╠════════════════════════════════════════════════════════════════╣"
echo "║  Mining Metrics (watch in browser):                            ║"
echo "║  • Jobs received from Braiins                                  ║"
echo "║  • Solver iterations & nonce discovery                         ║"
echo "║  • Memory compression state                                    ║"
echo "║  • Share submission & acceptance                               ║"
