...
class BillingRollbackManager:
    ...
    def refund_on_failure(self, execution_id: str, customer_id: str, 
                          work_units_consumed: int, reason: str) -> Dict[str, Any]:
        """
    ...
    def get_rollback_history(self, customer_id: Optional[str] = None,
        ...
        with self._lock:
            if customer_id:
                filtered = [r for r in self._rollback_log 
