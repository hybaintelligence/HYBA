...
class QuiescenceResponse(BaseModel):
    ...
    status: str = Field(..., description="Status string")
    synaptic_state_preserved: Optional[bool] = Field(None, description="Whether synaptic state was preserved")
...
class TelemetryResponse(BaseModel):
    ...
    stratum: Dict[str, Any] = Field(default_factory=dict, description="Stratum connection telemetry")
    ...
    sensory_integrity: Dict[str, Any] = Field(default_factory=dict, description="Sensory integrity report")
