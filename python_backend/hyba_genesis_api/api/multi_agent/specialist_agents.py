...
class DiagnosisAgent(SalamanderAgent):
    ...
    async def execute_task(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            diagnosis = await self._analyze_issue(task.prompt, task.target_files, task.context)
            ...
            return AgentResult(
                ...
                explanation=diagnosis.get("explanation", "Issue diagnosed successfully"),
                timestamp=time.time(),
    ...
    async def _analyze_issue(self, prompt: str, target_files: List[str], context: Dict) -> Dict[str, Any]:
...
class PlanningAgent(SalamanderAgent):
    ...
    async def execute_task(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            plan = await self._create_repair_plan(diagnosis, task.target_files, task.context)
    ...
    async def _create_repair_plan(self, diagnosis: Dict, target_files: List[str], context: Dict) -> Dict[str, Any]:
        """Create a structured repair plan with subtasks."""
        # Determine which specialists are needed based on file types
        backend_files = [f for f in target_files if any(ext in f for ext in ['.py', '.ts'])]
        frontend_files = [f for f in target_files if any(ext in f for ext in ['.tsx', '.jsx', '.css'])]
...
class BackendSpecialist(SpecialistAgent):
    ...
    async def _execute_domain_task(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            repair_plan = await self._generate_backend_repair(task.prompt, task.target_files, task.context)
    ...
    async def _generate_backend_repair(self, prompt: str, target_files: List[str], context: Dict) -> Dict[str, Any]:
        """Generate backend-specific repair plan."""
        return {
...
class FrontendSpecialist(SpecialistAgent):
    ...
    async def _execute_domain_task(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            repair_plan = await self._generate_frontend_repair(task.prompt, task.target_files, task.context)
    ...
    async def _generate_frontend_repair(self, prompt: str, target_files: List[str], context: Dict) -> Dict[str, Any]:
        """Generate frontend-specific repair plan."""
        return {
...
class VerificationSpecialist(SalamanderAgent):
    ...
    async def execute_task(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            verification_result = await self._run_verification(task.target_files, task.context)
            ...
            return AgentResult(
                ...
                explanation=verification_result.get("explanation", "Verification completed"),
                timestamp=time.time(),
                execution_time_ms=execution_time_ms
            )
    ...
    async def _run_verification(self, target_files: List[str], context: Dict) -> Dict[str, Any]:
...
class ExecutorAgent(SalamanderAgent):
    ...
    async def execute_task(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            execution_result = await self._apply_changes(task.target_files, task.context)
            ...
            return AgentResult(
                ...
                explanation=execution_result.get("explanation", "Changes applied successfully"),
                timestamp=time.time(),
                execution_time_ms=execution_time_ms
            )
    ...
    async def _apply_changes(self, target_files: List[str], context: Dict) -> Dict[str, Any]:
