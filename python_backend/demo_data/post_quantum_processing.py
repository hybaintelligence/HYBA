...
def process_with_pulvini(
    ...
    return {
        ...
        "compressed_size": result.folded_working_set_bytes
        + result.retained_kernel_bytes,
...
def process_with_post_quantum(
    ...
    print(
        f"  ✓ Compression ratio: {pulvini_results['working_set_compression_ratio']:.2f}x (working set)"
    )
    print(
        f"  ✓ Retained state ratio: {pulvini_results['retained_state_compression_ratio']:.2f}x (lossless)"
    )
...
def demonstrate_post_quantum_advantages(
    ...
    # Comparison
    results["comparison"] = {
        "pulvini_advantage": post_quantum_results["pulvini"][
            "working_set_compression_ratio"
        ]
        / traditional_ratio,
        "pulvini_working_set_ratio": post_quantum_results["pulvini"][
            "working_set_compression_ratio"
        ],
        "pulvini_retained_state_ratio": post_quantum_results["pulvini"][
    ...
    print(
        f"POST-QUANTUM (PULVINI): {post_quantum_results['pulvini']['working_set_compression_ratio']:.2f}x working set"
    )
    print(
        f"POST-QUANTUM (PULVINI): {post_quantum_results['pulvini']['retained_state_compression_ratio']:.2f}x retained state (lossless)"
    )
...
if __name__ == "__main__":
    ...
    print(
        f"POST-QUANTUM advantage: {comparison['comparison']['pulvini_advantage']:.2f}x"
    )
