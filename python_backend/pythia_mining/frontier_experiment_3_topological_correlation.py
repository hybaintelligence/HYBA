...
def run_topological_correlation_measurement(
    ...
    print("=" * 80)
    print()
    print("Hypothesis: Optimal discrepancy sharpens topological transitions")
    ...
    print(
        f"  → {'✓ Positive correlation detected' if correlation > 0.0 else '✗ No correlation or negative'}"
    )
    print()
