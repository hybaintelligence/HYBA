...
class ProductionMiningOrchestrator:
    ...
    async def _check_pool_health(self, pool_id: str, client: StratumClient) -> None:
        ...
        try:
            ...
            await asyncio.wait_for(client.poll_live_event(timeout=5.0), timeout=10.0)
    ...
    def _update_pool_health(
        self, pool_id: str, health: PoolHealth, error: Optional[str] = None
    ) -> None:
    ...
    def _record_pool_failure(self, pool_id: str, error: Optional[str] = None) -> None:
