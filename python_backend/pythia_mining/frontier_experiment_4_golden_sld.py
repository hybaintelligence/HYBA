...
def run_golden_sld_correlation_experiment(
    sample_sizes: List[int] = None, dim: int = 4
) -> Tuple[List[DiscrepancyQFIPoint], GoldenSLDAnalysis]:
    """
    ...
    print("-" * 80)
    print("Target: |r| > 0.8 AND R² > 0.8")
    print(
        f"Status: {'✅ BREAKTHROUGH ACHIEVED' if analysis.breakthrough_achieved else '❌ Threshold not met'}"
    )
