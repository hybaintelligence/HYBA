...
class GroverEnhancedQuantumSearch:
    ...
    def grover_multiple_marked(
        ...
        if len(probability_history) > 1:
            convergence_rate = (probability_history[-1] - probability_history[0]) / len(probability_history)
        else:
            convergence_rate = 0.0
    ...
    def quantum_walk_search(
        ...
        hitting_time = visited_states.index(target_state) if target_state in visited_states else max_steps
    ...
    def continuous_time_quantum_walk(
        ...
        # Calculate hitting time
        hitting_time = visited_states.index(target_state) if target_state in visited_states else time_steps
    ...
    def amplitude_amplification(
        ...
        amplification_factor = final_success / (initial_success + 1e-10) if initial_success > 1e-10 else 1.0
