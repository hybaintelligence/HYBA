...
class ProductionMiningGateway:
    ...
    def build_profiles_from_env() -> List[PoolProfile]:
        ...
        while True:
            ...
            tls_required = os.getenv(f"HYBA_POOL_{pool_index}_TLS_REQUIRED", "false").lower() == "true"
    ...
    def validate_profiles(profiles: List[PoolProfile]) -> None:
        ...
        for profile in profiles:
            ...
            # Validate URL format
            if not profile.url.startswith(("stratum://", "stratum+ssl://", "stratum+tls://",
                                          "stratum2://", "stratum2+ssl://", "stratum2+tls://")):
                raise PoolConfigurationError(
