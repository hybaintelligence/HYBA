...
The reviewer-facing claim is deliberately bounded: this module verifies a
runtime integration proxy and its continuous hardware-scaling guardrails. It does
not assert phenomenal consciousness.
"""
